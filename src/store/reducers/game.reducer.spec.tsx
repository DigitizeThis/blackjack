...
import reducer, { statuses } from './game.reducer';
...
describe('Reducer', () => {
    ...
    describe('DEAL', () => {
        ...
        it('ensures that a dealers card is face down', () => {
            store.dispatch({ type: 'DEAL' });
    ...
    describe('OUTCOME', () => {
        ...
        it('turns all dealer cards face up', () => {
            ...
            store.getState().dealerHand.every((c: any) => !c.faceDown).should.be.true;
        });
